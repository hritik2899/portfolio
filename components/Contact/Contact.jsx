...
const links = [
{
    ...
    link:'mailto:hritik.gupta.2899@gmail.com'
},
{
    name:'LinkedIn',
    icon:'/Contact/linkedin.svg',
    link:'https://www.linkedin.com/in/hritik-gupta-96268b243/'
},
{
    name:'GitHub',
    icon:'/Contact/github.svg',
    link:'https://github.com/hritik2899/'
},
{
    name:'Instagram',
    icon:'/Contact/instagram.svg',
    link:'https://www.instagram.com/hritikgupta0607/'
},
]
    ...
    return (
        <div className={styles.contact} id="contact">
            ...
            <div className={styles.right}>
                ...
                <a href={`mailto:hritik.gupta.2899@gmail.com?from=${email}&name=${name}&body=${message}`} className={styles.submit} >Submit</a>
            </div>
        </div>
    )
}
